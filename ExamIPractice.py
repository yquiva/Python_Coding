...
if quantityA < 0 or quantityB < 0 or quantityC < 0 or quantityD < 0:
    print ("However, one or more of the values ingressed are negative, and that is not an option. The program will be closed now without making any calculations.")
else:
